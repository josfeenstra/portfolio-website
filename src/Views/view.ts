...
export class View 
{
    ...
    {  
        ...
        if (this.route.hash =="#about") { 
            Dom.TrySetElementAttributeById<HTMLCanvasElement>("canvas", "data-goto", "side");
        } else if (this.route.hash =="#website") {
            Dom.TrySetElementAttributeById<HTMLCanvasElement>("canvas", "data-goto", "inside");
        } else {
            Dom.TrySetElementAttributeById<HTMLCanvasElement>("canvas", "data-goto", "low-side");
        }
    }
