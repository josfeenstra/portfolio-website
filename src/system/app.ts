...
export class App {
    ...
    static RenderSocials(context: Element) {
        ...
        footers.innerHTML = `
        <a href="mailto:me@josfeenstra.nl" type="button" class="btn btn-outline-light">
        ...
        <a href="https://github.com/josfeenstra" type="button" class="btn btn-outline-light">
        ...
        <a href="https://www.linkedin.com/in/jos-feenstra-007369122/" type="button" class="btn btn-outline-light">
